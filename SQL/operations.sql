...
CREATE OR REPLACE PROCEDURE addOrder(
    ...
    business_account_ref REF BusinessAccountTY;
    team_ref REF TeamTY;
BEGIN
    SELECT REF(b)
    INTO business_account_ref
    FROM BusinessAccountTB b
    WHERE b.CODE = businessAccountName;

    INSERT INTO OrderTB (ID, placingDate, orderMode, orderType, cost, businessAccount, employees) VALUES (ID, placingDate, orderMode, orderType, cost, business_account_ref, employees);
    COMMIT;
END;
/
